...
from .utils import encrypt_for_devices
...
async def get_states(hass: HomeAssistant) -> tp.Dict[
    ...
    if hass.data[DOMAIN][CONF_CARBON_SERVICE]:
        ...
        all_data["energy"] = {"energy": used_energy, "geo": (geo.attributes['latitude'], geo.attributes['longitude'])}
...
async def get_and_send_data(hass: HomeAssistant):
    ...
    try:
        ...
        filename = write_data_to_file(data_final, data_path)
